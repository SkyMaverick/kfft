...
typedef kfft_csparse_t* (*kfft_callback_config_sparse_cpx)(const uint32_t nfft,
                                                           const uint32_t flags,
                                                           const uint32_t dims, uint32_t step,
                                                           kfft_pool_t* A, size_t* lenmem);
typedef kfft_return_t (*kfft_callback_eval_sparse_cpx)(kfft_csparse_t* cfg, const kfft_cpx* fin,
                                                       kfft_cpx* fout);
typedef void (*kfft_callback_shift_sparse_cpx)(kfft_cpx* buf, kfft_cpx* ftmp, const uint32_t nfft,
                                               const uint32_t dims, uint32_t step,
