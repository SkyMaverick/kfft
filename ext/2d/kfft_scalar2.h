...
KFFT_API kfft_return_t
kfft_eval2_scalar_norm(kfft_sclr2_t* cfg, const kfft_scalar* fin, kfft_scalar* fout);
KFFT_API kfft_return_t
...
(*kfft_callback_eval2_scalar)(kfft_sclr2_t* cfg, const kfft_scalar* fin, kfft_cpx* fout);
typedef kfft_return_t
(*kfft_callback_eval2_scalar_norm)(kfft_sclr2_t* cfg, const kfft_scalar* fin, kfft_scalar* fout);
typedef kfft_return_t
(*kfft_callback_evali2_scalar)(kfft_sclr2_t* cfg, const kfft_cpx* fin, kfft_scalar* fout);
typedef void
