...
(*kfft_callback_eval2_scalar)(kfft_plan_s2d* cfg, const kfft_scalar* fin, kfft_cpx* fout);
typedef kfft_return_t
(*kfft_callback_eval2_scalar_norm)(kfft_plan_s2d* cfg, const kfft_scalar* fin, kfft_scalar* fout);
typedef kfft_return_t
(*kfft_callback_evali2_scalar)(kfft_plan_s2d* cfg, const kfft_cpx* fin, kfft_scalar* fout);
typedef void
